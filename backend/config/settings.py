...
PAGE_PERMS = {
    ...
    "SEED_ROUTES": [
        ...
        {"path": "/app/settings/kpi-scoring", "label": "KPI 评分规则", "icon": "i-heroicons-adjustments-horizontal", "permission": None, "sort_order": 8, "meta": {"superuserOnly": True}},
        {"path": "/app/settings/backups", "label": "数据库备份", "icon": "i-heroicons-circle-stack", "permission": None, "sort_order": 9, "meta": {"superuserOnly": True}},
